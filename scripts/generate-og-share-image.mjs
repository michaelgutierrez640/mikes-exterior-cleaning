...
/** Max logo footprint inside the card (leaves safe margin around edges). */
const MAX_LOGO_WIDTH_RATIO = 0.58
const MAX_LOGO_HEIGHT_RATIO = 0.52
...
// Proportional fit only — no sharpen, no pixel cleanup, no color changes.
...
console.log(`Source (unmodified): ${logoPath} (${logoMeta.width}×${logoMeta.height})`)
console.log(`Wrote ${outPath} (${meta.width}×${meta.height} ${meta.format}); logo placed at ${logoW}×${logoH}`)
