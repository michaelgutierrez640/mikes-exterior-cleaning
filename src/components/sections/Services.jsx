      ...
      <div className="section-container relative">
        <ScrollReveal className="section-header">
          ...
          <p className="section-subtitle">
            Professional exterior cleaning for homes and businesses across Modesto, Manteca,
            Riverbank, Turlock, Salida, and Ripon.
          </p>
        </ScrollReveal>

        <div className="section-content grid gap-5 sm:grid-cols-2 sm:gap-6">
