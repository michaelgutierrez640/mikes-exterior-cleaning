  ...
  return (
    <>
      ...
      <section className="section-container -mt-10 pb-20">
          ...
          <div className="space-y-8">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                <button className="btn-secondary btn-sm !rounded-xl" onClick={() => refresh()}>
                  Refresh
                </button>
                <button
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              ...
              <StatCard
                ...
                value={formatCurrency(business?.avgQuoteValue ?? 0)}
              />
              <div className="rounded-2xl border border-black/[0.06] bg-white p-6 shadow-[0_1px_3px_rgba(10,22,40,0.06)]">
        ...
        {status === 'loading' && (
          <div className="mx-auto max-w-2xl rounded-2xl border border-black/[0.06] bg-white p-7 text-center shadow-[0_1px_3px_rgba(10,22,40,0.06)]" role="status" aria-live="polite">
