...
export function normalizeLeadPhotos(input) {
  ...
  for (const raw of input) {
    ...
    // Store is the shared Vercel Blob store (public access mode, same as completed-jobs).
    // Paths remain unguessable via random suffixes and are never listed publicly.
    photos.push({
      pathname,
