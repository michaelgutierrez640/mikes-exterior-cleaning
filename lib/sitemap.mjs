...
const wcCities = ['modesto', 'salida', 'riverbank', 'oakdale', 'ripon', 'turlock', 'ceres', 'tracy', 'stockton', 'manteca']
...
export function buildSitemapXml(lastmod = new Date().toISOString().split('T')[0]) {
  const urls = [
...
export function getSitemapUrlCount() {
  return (
    5 +
    services.length +
    articles.length +
